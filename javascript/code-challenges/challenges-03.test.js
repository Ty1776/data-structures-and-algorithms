...
const containsAnd = (arr) => {
  // Solution code here...
  let filteredContainsAnd = arr.filter(str => str.includes('and'));
  return filteredContainsAnd;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let filteredOddValues = arr.filter(odd => odd%2);
  return filteredOddValues;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  return arr.filter(int => !forbiddenValues.includes(int));
};
